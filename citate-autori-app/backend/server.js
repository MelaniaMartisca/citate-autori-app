...
app.use("/images", express.static(path.join(__dirname, "images"))); //construieste calea catre imagini cu metoda join, concateneaza
// Ruta de test
app.get("/", (req, res) => {
  res.json({
...
const PORT = process.env.port || 5000; //env pt deployment
app.listen(PORT, () => {
  //asculta cererile, 2 parametri port si cv function
